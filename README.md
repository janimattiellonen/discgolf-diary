...
Kiersin Talin kahten kertaan. Ensimmäinen kierros meni käytännössä "lämmitellen", vaikkakin sain 4 pirkkoa kierroksella (väylillä 3, 11, 16 ja 18)! Toinen kierros tuntui menevän paremmin tuloksella +8.
...
Aloitin kietämällä väylät 1-6, mutta fiilis oli sen verran paska, että loput ajasta harjoittelin annukka-avauksia 15. väylällä. Aika moni avaus lähti ihan kivasti ja jopa ihan korille asti.
...
Avausharjoittelua Jallen neuvojen mukaan (yritin ainakin). Aluksi availin 12. väylän tiiltä 18. väylän korille. Kiersin myös väylät 1-11 ja lopetin avaamalla muutaman kerran 11. väylällä.
...
Tänään perinteistä avausharjoittelua. Availin myös väylältä 12. Ei mitään suurempaa sanottavaa.
...
- 29.5.2017:
    ...
    - julkaise video omasta heitoista
  
    - julkaise reddittiin postaus, jossa video ja pyydä analyysiä
  
    - listaa suurimmat ongelmat ja luo niiden pohjalta uusi harjoitusohjelma ja keskity yhteen epäkohtaan kerralla
  
    - videoi uudestaan heittoja, joissa olet yrittänyt korjata tiettyä ongelmaa
  
    - postaa reddittiin uusi video kun tunnet, että edistytä on tapahtunut
...
- harjoittele avauksia Talin 8. väylällä. Se on haastava ja hyötyisin, jos saisin avaukset menemään hyvin suuremmalla todennäköisyydellä
